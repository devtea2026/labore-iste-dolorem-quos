# @devtea2026/labore-iste-dolorem-quos
...
Next, install `@devtea2026/labore-iste-dolorem-quos`:

```bash
npm install @devtea2026/labore-iste-dolorem-quos --save-dev
```

**Note:** If you installed ESLint globally (using the `-g` flag) then you must also install `@devtea2026/labore-iste-dolorem-quos` globally.
